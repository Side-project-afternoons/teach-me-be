...
const courseController = {
    ...
    async addCourse(req,res) {
        res.status(200).json(await Courses.addCourse(req.body))
    },
    async addCourseToUser(req,res) {
        res.status(200).json(await Courses.addUserCourse(req.body))
    },
    async editCourse(req,res) {
        res.status(200).json(await Courses.editCourse(req.body))
    },
    async deleteUserCourse(req,res) {
        res.status(200).json(await Courses.deleteUserCourse(req.body))
    },
